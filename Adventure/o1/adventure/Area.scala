...
class Area(var name: String, var description: String, private val drinkable: Boolean) {

  private val neighbors = Map[String, Area]()
  private val items = Map[String, Item]()

  def isDrinkable: Boolean = drinkable

  /** Surprising locations that trigger specific events or are the outcomes of specific events, such as falling down the waterfall. */
  def isWaterFall: Boolean = name == "Over the Waterfall"
  ...
  def fullDescription = {
    ...
    var print = this.description
    if (items.nonEmpty) print += "\nYou see here: " + this.items.keys.mkString(" ")
    print += exitList
    print
  }
